...
# Load the dataset
dataset = horse2zebraDataset("Data/horse2zebra", transform  = transform)
...
def train_CycleGAN_DWS():
    """
    Function to train CycleGAN with depthwise seperable blocks. Doesn't take any inputs.
    
    Outputs: Saves the model to disk
             Displays the real and generated images after every few steps (If code is not commented out)
...
# Print a message which model is being trained
print("TRAINING: CYCLEGAN_DWS")
# Train the CycleGAN_DWS
train_CycleGAN_DWS()
