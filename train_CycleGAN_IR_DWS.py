...
# Load the dataset
dataset = horse2zebraDataset("Data/horse2zebra", transform  = transform, mode="train")
...
if load_model == True:
    ...
    CycleGAN_dict = torch.load("Model Weights/CycleGAN_IR_DWS/CycleGAN_IR_DWS_epoch100.pth")
